...
import ParquetLayer from "./ParquetLayer";
...
export const viewerMetadata: ViewerMetadata = {
  ...
  compatibilityCheck: (props: FileProps) => {
    ...
    if (props.filename.toLowerCase().endsWith(".parquet") || props.filename.toLowerCase().endsWith(".geoparquet")) {
      return true;
    }
...
export function MapViewer(props: FileProps) {
  ...
  } else if (filename.toLowerCase().endsWith(".parquet") || filename.toLowerCase().endsWith(".geoparquet")) {
    dataSource = DataSourceType.PARQUET;
  }
  ...
  useEffect(() => {
    if (dataSource === DataSourceType.PARQUET) {
      return;
    }
    ...
    try {
      ...
      } else if (dataSource === DataSourceType.GEOJSON) {
